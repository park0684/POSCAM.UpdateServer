...
| B11 | Manifest 파일별 복구 업데이트 | InProgress | 미실행 | 미실행 | B11 문서, schema/migration, UpdateArtifactFile Entity/Repository/DI, Repository SQL tests | DB/Entity/Repository 단계 완료, Storage/Upload/UpdateCheck 연결 전 |
