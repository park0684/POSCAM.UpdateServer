...
| B11 | Manifest 파일별 복구 업데이트 | InProgress | Release 성공, 경고 0 | 310/310 성공 | B11 문서, schema/migration, UpdateArtifactFile Entity/Repository/DI, ArtifactFileManifestService, Repository/Storage tests | Manifest Storage 단계까지 검증 완료, Upload/UpdateCheck 연결 전 |
